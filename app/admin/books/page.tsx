...
// const books = [
//   { title: "Atomic Habits", author: "James Clear", status: "Published", type: "PDF", downloads: "1,240" },
//   { title: "The Purpose Driven Life", author: "Rick Warren", status: "Published", type: "PDF", downloads: "980" },
//   { title: "Think and Grow Rich", author: "Napoleon Hill", status: "Draft", type: "EPUB", downloads: "0" },
//   { title: "The Power of Prayer", author: "Stormie Omartian", status: "Published", type: "Audio", downloads: "705" },
// ];
...
//               Back to Admin
//             </Link>
//             <h1 className="text-4xl font-black text-[#000D24]">Books & Resources</h1>
//           </div>
...
//               <tbody>
//                 {books.map((book) => (
//                   <tr key={book.title} className="border-b border-slate-100">
//                     <td className="py-5">
//                       <div className="flex items-center gap-3">
//                         <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#000D24] text-white">
//                           <BookOpen size={20} />
//                         </div>
//                         <div>
//                           <p className="font-black">{book.title}</p>
//                           <p className="text-xs text-slate-500">Personal Growth</p>
//                         </div>
//                       </div>
//                     </td>

//                     <td className="py-5 text-sm font-semibold text-slate-600">{book.author}</td>
//                     <td className="py-5 text-sm font-black text-slate-700">{book.type}</td>
...
//                     <td className="py-5 text-sm font-black text-slate-700">{book.downloads}</td>

//                     <td className="py-5">
//                       <div className="flex justify-end gap-2">
//                         <button className="rounded-xl bg-slate-100 p-3 text-slate-600">
//                           <Edit size={16} />
//                         </button>
